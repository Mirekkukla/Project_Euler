#Project Euler prob 18: p18.py
#go down the pyramid starting at the top, and at each row
#store the running sun for the i.jth entry to be
#the max of running sums accessible above, plus the i,jth entry
#return the max of the running sums on the bottom row
